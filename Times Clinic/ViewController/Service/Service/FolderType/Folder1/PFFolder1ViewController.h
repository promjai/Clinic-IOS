...
@protocol PFFolder1ViewControllerDelegate <NSObject>
...
@interface PFFolder1ViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
