...
@interface PFFolder1ViewController ()

@end

@implementation PFFolder1ViewController
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if ([self.navigationController.viewControllers indexOfObject:self] == NSNotFound) {
        ...
        if([self.delegate respondsToSelector:@selector(PFFolder1ViewControllerBack)]){
            [self.delegate PFFolder1ViewControllerBack];
        }
    }
}
